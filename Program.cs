...
namespace BasicGraphSearch
{
    class Program
    {
        ...
        /*
            ...
            * Затем ищем вершину с минимальным растоянием и меткой(value) 0. Затем обходим список по порядку, 
            * начиная с мнимального, захватывая соседние вершины. На каждой итерации выбираем наименьший путь(value).
